...
7. Home directory .env files
8. MCP config (~/.config/mcp/.mcp.json)
...
def get_confluence_credentials(env_file: Optional[str] = None) -> Dict[str, str]:
    ...
    # Priority 3: .env files in current directory
    ...
    # Priority 4: Walk up parent directories
    ...
    # Priority 5: Home directory .env files
    for env_variant in ENV_FILE_VARIANTS:
